...
class Scanner {
    ...
    public TokenInfo getNextToken() {
        ...
        case '~':
            nextCh();
            return new TokenInfo(B_NOT, line);
        case '>':
            nextCh();
            if (ch == '='){
                nextCh();
                ...
                if (ch == '='){
                    ...
                    if (ch == '='){
                        nextCh();
                        return new TokenInfo(U_R_SHIFT_ASSIGN, line);
                    }
                    return new TokenInfo(U_R_SHFIT, line);
                }else
        ...
        case '<':
            ...
            if (ch == '=') {
                ...
                if ( ch == '='){
                    ...
                    if (ch == '='){
                        nextCh();
                        return new TokenInfo(U_L_SHIFT_ASSIGN, line);
                    }
                    return new TokenInfo(U_L_SHIFT, line);
                }
                return new TokenInfo(LEFT_SHIFT, line);
                
            } 
            else {
                return new TokenInfo(SMALLER,line);
            }
        case '\'':
