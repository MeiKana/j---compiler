...
enum TokenKind {
    ...
    FINAL("final"), FINALLY("finally"), FOR("for"), IMPLEMENTS("implements"),
    ...
    DIV("/"), NOT_EQUAL("!="), DIV_ASSIGN("/="), MINUS_ASSIGN("-="), 
    STAR_ASSIGN("*="), REM("%"), REM_ASSIGN("%="), RIGHT_SHIFT(">>"), 
    LEFT_SHIFT("<<"), RIGHT_SHIFT_ASSIGN(">>="), LEFT_SHIFT_ASSIGN("<<="),
    GREAT_EQUAL(">="), SMALL_EQUAL("<="), SMALLER("<"), LOR("||"), U_R_SHFIT(">>>"),
    U_L_SHIFT(">>>"), B_AND("&"), B_AND_ASSIGN("&="), B_OR("|"), B_OR_ASSIGN("|="),
    XOR("^"),XOR_ASSIGN("^=") ,COND("?"), B_NOT("~"), U_R_SHIFT_ASSIGN(">>>="),
    U_L_SHIFT_ASSIGN("<<<="),
    ...
    STRING_LITERAL("<STRING_LITERAL>"), DOUBLE_LITERAL("<DOUBLE_LITERA>"),
